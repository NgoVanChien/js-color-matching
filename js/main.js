...
//   if (isMatch) {
//     // check win ( opennd 8 pair of colors)
//     const isWin = getInActiveColorList().length === 0
...
//     const overlayElememt = liElement.querySelector('.overlay')
//     if (overlayElememt) overlayElememt.style.backgroundColor = colorList[index]
//   })
// }
